...
/*
    ...
    : 스프링을 쉽고 빠르게 사용할수 있도록 지원하는 프레임워크 확장판
    ...
    3) DS >> 핸들러 어댑터
     ...
     4. DispatcherServlet(디스패치 서블릿, dispatch 보내다)
     : 스프링부트의 핵심 서블릿
...
/*
    ...
    1. 서블릿
        ...
        2) 기능/URI 마다 여러 서블릿을 만들거나, 집접 프론트 컨트롤러 패턴(서블릿1개 + 내부 분기)을 구현

    2. 스프링부트(MVC)
        1) DispatcherServlet 하나가 관문
            - 그 야래는 컨트롤러 메서드 단위로 라우팅
